...
export const PricingView: React.FC = () => {
  ...
  const handleFreeStarter = () => {
    ...
    addNotification("Starter Tier Active", "You get 500 Free AI Credits with a 3-day refresh cycle.", "success");
  };
  ...
  const plans = [
    {
      ...
      badge: "Free 500 Credits",
      priceMonthly: 0,
      priceAnnual: 0,
      description: "Essential tools for casual video editing and social media creators with automatic 3-day reset.",
      features: [
        "1080p Export Quality",
        "Multi-track Timeline (up to 4 tracks)",
        "500 Free AI Credits (Refreshes Every 3 Days)",
        "1 Photo = 5 Credits",
        "1 Video = 10 Credits",
        "AI Prompts = 10 Credits",
        "Standard Transitions & Shaders",
        "High-Security Password Protection",
      ],
    ...
    },
    {
      ...
      priceAnnual: "PKR 1,500",
      description: "Official JazzCash transfer with verified TID security before unlocking Pro tools.",
      features: [
        "JazzCash Account: 03176901963 (Abdullah)",
        "Verified Transfer Security Gate",
        "50,000 High-Capacity AI Credits",
        "4K 60FPS Ultra HD Master Export",
        "Unlimited Timeline Tracks & Overlays",
        "AI Photo & Background Mod Studio",
        "Veo 3.1 & Cinematic Video Generator",
        "Viral YouTube & TikTok Thumbnail Generator",
        "Logo & Brand Promo Studio (Vector SVG)",
        "No Watermark on Exports",
        "Priority Gemini Live Voice Mode (Urdu & English)",
      ],
    ...
    },
    {
      ...
      badge: "Full Access",
      priceMonthly: "PKR 3,000",
      priceAnnual: "PKR 3,000",
      description: "For teams, studios, and production houses requiring dedicated VIP rendering nodes.",
      features: [
        "JazzCash Account: 03176901963 (Abdullah)",
